...
# search the image for the beacon
...
#detected the contours of the object and place bounding box
def detect_frontal_object(image):
    imageSize = 0

    return imageSize

#determine how to navigate around the object
...
#filter out the no beacons from the beacon detection and return average
...
#simple averaging function for a marker class
def regAverage(x):
    tmpx = 0.0
    tmpy = 0.0
    tmpz = 0.0
